                    ...
                    <div class="col-lg-6 gx-5">
                        <div class="shadow-none mb-5 bg-light rounded">
                            <div class="row">
                                ...
                                <div class="col-lg-9 justify-content-center p-3">
                                    <h5>Language</h5>
                                    <p class="text-secondary">Language configurations include adding keywords, creating new languages, and more.</p>
                                    <a href="">Update Settings</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 gx-5 ">
                        <div class="shadow-none mb-5 bg-light rounded">
                            <div class="row">
                                ...
                                <div class="col-lg-9 justify-content-center p-3">
                                    <h5>SEO</h5>
                                    <p class="text-secondary">Social title, Social description, Meta image, Meta keywords, and so forth.</p>
                                    <a href="}">Update Settings</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 gx-5 ">
                        <div class="shadow-none mb-5 bg-light rounded">
                            <div class="row">
                                ...
                                <div class="col-lg-9 justify-content-center p-3">
                                    <h5>Plugins</h5>
                                    <p class="text-secondary">Send messages to your clients, use reCAPTCHA to secure your website and so forth.</p>
                                    <a href="">Update Settings</a>
                                </div>
                            </div>
                        </div>
